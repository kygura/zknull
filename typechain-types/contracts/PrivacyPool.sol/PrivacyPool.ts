...
export namespace PoolWithdrawalEvent {
  export type InputTuple = [
    to: AddressLike,
...
export interface PrivacyPool extends BaseContract {
  ...
  getEvent(
    ...
    PoolWithdrawalEvent.InputTuple,
    PoolWithdrawalEvent.OutputTuple,
    PoolWithdrawalEvent.OutputObject
  >;
  getEvent(
    key: "Withdrawal"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "PoolDeposit(bytes32,uint32,uint256)": TypedContractEvent<
      PoolDepositEvent.InputTuple,
      PoolDepositEvent.OutputTuple,
      PoolDepositEvent.OutputObject
    >;
    ...
    "PoolWithdrawal(address,bytes32,address,uint256)": TypedContractEvent<
      PoolWithdrawalEvent.InputTuple,
      PoolWithdrawalEvent.OutputTuple,
      PoolWithdrawalEvent.OutputObject
    >;
    PoolWithdrawal: TypedContractEvent<
      PoolWithdrawalEvent.InputTuple,
      PoolWithdrawalEvent.OutputTuple,
      PoolWithdrawalEvent.OutputObject
    >;
