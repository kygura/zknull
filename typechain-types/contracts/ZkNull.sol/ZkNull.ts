...
export interface ZkNullInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "LEVELS"
      | "ROOT_HISTORY_SIZE"
...
export interface ZkNull extends BaseContract {
  connect(runner?: ContractRunner | null): ZkNull;
  waitForDeployment(): Promise<this>;

  interface: ZkNullInterface;
