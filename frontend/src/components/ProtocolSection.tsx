      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-20 border border-border bg-card">
          <div className="border-b border-border px-4 py-2 flex items-center gap-2">
            ...
            <span className="font-mono text-xs text-muted-foreground ml-2">zkNull://zkStats</span>
          </div>
          <div className="p-6 font-mono text-sm space-y-2">
            ...
            <div className="pl-4 text-muted-foreground">
              ticker: <span className="text-foreground">$ZKNULL</span>,
            </div>
            <div className="pl-4 text-muted-foreground">
              total_supply: <span className="text-foreground">100_000_000 </span>,
            </div>
            <div className="pl-4 text-muted-foreground">
              circulating: <span className="text-foreground">42_850_000</span>,
            </div>
            <div className="pl-4 text-muted-foreground">
              burnt: <span className="text-foreground">7_150_000</span>,
            </div>
            
            <div className="pl-4 text-muted-foreground">
              collateral_ratio: <span className="text-primary">1.12</span>,
            </div>
